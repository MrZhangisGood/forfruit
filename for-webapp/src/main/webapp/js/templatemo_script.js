...
jQuery(function()
{
    ...
    $(document).scroll(function(){
        ...
        var event = $("#templatemo_upcomming_event");
        if(event.length == 0){
            return;
        }
        event_wapper_top = event.position().top;
    ...
    $(document).scroll(function(){
        ...
        var event = $("#templatemo_pricing");
        if(event.length == 0){
            return;
        }
        event_wapper_top = event.position().top-1110;
        if(document_top<event_wapper_top){
    ...
    $(document).scroll(function(){
        ...
        var event = $("#templatemo_blog");
        if(event.length == 0){
            return;
        }
        event_wapper_top = event.position().top-2110;
        if(document_top<event_wapper_top){
            event_animate_num = event_wapper_top - document_top;
            event_animate_alpha = (1/event_wapper_top)*(document_top);
    ...
    $(document).scroll(function(){
        ...
        var event = $("#templatemo_contact");
        if(event.length == 0){
            return;
        }
        event_wapper_top = event.position().top-3110;
        if(document_top<event_wapper_top){
            event_animate_alpha = (1/event_wapper_top)*(document_top);
